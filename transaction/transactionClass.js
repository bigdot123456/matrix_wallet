...
module.exports = class transactionClass extends promptClass{
    ...
    createTrans(){
        ...
        return {from:this.from,to:this.to,value:value,data:this.data+Bytes2HexString(this.ExtraData),gas:this.gas,gasPrice:this.gasPrice,nonce:this.nonce,chainId:this.chainId};
    }
